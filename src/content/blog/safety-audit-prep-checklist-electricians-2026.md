...
faq:
  - question: "What documents do I need for an electrical safety audit?"
    answer: "You need: (1) current electrical contractor licence, (2) CCEW/CES certificates for all notifiable work from the past 12 months, (3) AS/NZS 3000 test records for completed installations, (4) safe work method statements (SWMS) for high-risk work, (5) insurance certificates ($5M+ public liability), and (6) worker induction and competency records. Missing any of these is the #1 audit failure trigger."
  - question: "What triggers a SafeWork NSW electrical audit?"
    answer: "SafeWork NSW audits are triggered by: (1) a notifiable incident or complaint, (2) random industry blitz targeting specific trades (solar installers were targeted in 2025/2026), (3) a previous non-compliance finding requiring follow-up, or (4) a cross-agency referral from NSW Fair Trading or a DNSP. Audits can be announced (14 days notice) or unannounced."
  - question: "What are the most common electrical safety audit failures?"
    answer: "The top 5 audit failures are: (1) missing or incomplete CCEW certificates, (2) test records not matching AS/NZS 3000 requirements, (3) no SWMS for high-risk construction work, (4) expired or incorrect class of electrical licence, (5) poor cable management and labelling in switchboards. 80% of auditors check switchboard labelling first — it sets the tone for the entire audit."
  - question: "How do I prepare for an ESV (Victoria) electrical safety audit?"
    answer: "ESV audits require the CES (Certificate of Electrical Safety) to be lodged within 30 days (not 7 like NSW CCEW). ESV cross-references CES records against DNSP connection data — discrepancies trigger an automatic audit flag. Ensure your CES records match your job management system exactly, and that all solar installations have a separate CES for the AC and DC sides."
  - question: "Is there a downloadable electrical safety audit checklist?"
    answer: "Yes — this article includes a free downloadable PDF checklist covering all 6 audit categories: licensing, certificates, test records, SWMS, insurance, and on-site safety. Download it at the end of the article and keep a printed copy in your switchboard prep area."
---
...
<div class="compliance-bridge-box" style="border-left:4px solid #f97316;background:#0f172a;padding:20px 24px;border-radius:8px;margin:32px 0;color:#e2e8f0">
  <div style="display:flex;gap:16px;align-items:center;flex-wrap:wrap">
    <div style="flex:1;min-width:220px">
      <strong style="display:block;font-size:1.05rem;margin-bottom:4px">Worried about an upcoming audit? Download the free 6-category checklist.</strong>
    ...
    <a href="#download-checklist" style="background:#f97316;color:#fff;padding:12px 20px;border-radius:8px;font-weight:700;text-decoration:none;white-space:nowrap;flex-shrink:0">
      Download Checklist →
    </a>
  </div>
</div>
...
| State | Certificate Type | Lodgement Deadline | Penalty Caps |
|-------|-----------------|-------------------|--------------|
| NSW | CCEW | 7 days | $22K / $110K |
| VIC | CES | 30 days | $10K / $50K+ |
| QLD | CoTC | 30 days | $45K / $220K |
| WA | ESC (eNotice) | 14 days | $25K / $125K |
| SA | Certificate of Compliance | No central lodgement | $20K / $100K |
...
| Audit Category | How ServiceM8 Helps |
|---------------|-------------------|
| **Licensing** | Store licence certificates in the **Company Documents** section. Set expiry reminders so nothing lapses. |
| **Compliance Certificates** | Generate CCEW/CES/CoTC templates from job data. Attach lodged certificates directly to the job card. |
| **Test Records** | Upload AS/NZS 3000 test sheets to the job's **Documents** tab. Searchable by job number or property address. |
| **SWMS** | Create SWMS templates as **Custom Forms**. Workers complete and sign on-site via the mobile app before starting work. |
| **Insurance** | Store all insurance certificates as permanent documents. Expiry reminders keep you ahead of renewal dates. |
| **On-Site Safety** | Attach **photos of switchboard labelling**, RCD test logs, and completed checklists to the job card. Every job has its own compliance trail. |
...
<a id="download-checklist"></a>

<div style="background:#1e293b;border:2px solid #f97316;border-radius:12px;padding:32px;text-align:center;margin:32px 0">
  <h3 style="margin:0 0 8px 0;color:#fff;font-size:1.3rem">Free Download: Electrical Safety Audit Prep Checklist (PDF)</h3>
  <p style="color:#94a3b8;margin:0 0 20px 0;font-size:0.95rem">Printable 6-category checklist + state-by-state deadline card + pre-audit one-pager. Print it, post it, and know exactly what auditors check before they arrive.</p>
  <a href="/lead-magnets/safety-audit-prep-checklist" style="display:inline-block;background:#f97316;color:#fff;padding:14px 32px;border-radius:8px;font-weight:700;text-decoration:none;font-size:1.05rem">
    Download the Checklist (Free) →
  </a>
  <p style="color:#64748b;font-size:0.8rem;margin:12px 0 0 0">No spam. Instant download. PDF format — print and post.</p>
</div>
