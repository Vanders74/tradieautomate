...
<div class="exit-quiz-cta" style="background:linear-gradient(135deg,#0f172a,#1e293b);border-radius:16px;padding:28px 24px;margin:24px 0;color:#e2e8f0;border:1px solid #334155;">
  <div style="font-size:1.6rem;margin-bottom:10px;">🚀</div>
  <h3 style="margin:0 0 8px;font-size:1.3rem;color:#f97316;">Take the 3-Minute Exit-Readiness Quiz</h3>
  <p style="margin:0 0 16px;font-size:0.95rem;color:#94a3b8;line-height:1.6;">
    A buyer isn't buying your client list — they're buying a business that runs without you.
    Answer 12 quick questions and find out if your trade business is a <strong style="color:#f1f5f9;">sellable asset</strong> or a <strong style="color:#f1f5f9;">job that runs on you</strong>. You'll get an instant score plus a <strong style="color:#f1f5f9;">custom action plan PDF</strong>.
  </p>
  <a href="/exit-readiness" style="display:inline-block;background:#f97316;color:#fff;padding:12px 24px;border-radius:8px;font-weight:700;text-decoration:none;transition:background 0.15s;" onmouseover="this.style.background='#ea580c'" onmouseout="this.style.background='#f97316'">Take the free quiz →</a>
  <p style="margin:12px 0 0;font-size:0.75rem;color:#64748b;">Free. Instant. No credit card.</p>
</div>
