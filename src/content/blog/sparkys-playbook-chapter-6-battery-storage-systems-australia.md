...
faq:
  - question: "What standard governs battery storage installations in Australia?"
    answer: "AS/NZS 5139:2019 is the primary standard for battery energy storage systems (BESS) in Australia. It covers the design, installation, and commissioning of battery systems for residential and commercial applications. It works alongside AS/NZS 3000 (the Wiring Rules) and AS/NZS 4777 (grid connection). AS/NZS 5139 introduced significant requirements around installation location, separation distances, fire protection, ventilation, and safety systems that don't apply to solar-only installations."
  - question: "Do I need CEC battery accreditation to install battery systems?"
    answer: "Yes. The Clean Energy Council requires separate battery installation accreditation for electricians installing battery energy storage systems connected to the grid or to a solar system. If you hold CEC Solar Accreditation (Grid-connect PV), you'll need to complete the additional battery unit to add battery accreditation. Without it, you cannot install batteries under the STC scheme or access the installer rebates available in states like SA and VIC."
  - question: "What are the main AS/NZS 5139 requirements for residential battery installations?"
    answer: "Key requirements include: minimum separation distances from ignition sources, windows, doors, and air intakes (varies by battery chemistry and energy capacity); ventilation requirements where batteries can off-gas; fire separation requirements for batteries installed in enclosed spaces; prohibitions on installation in certain locations (occupied sleeping areas, escape routes); mandatory labelling and signage; and documentation requirements including a Battery Installation Certificate. Each battery manufacturer also has specific installation requirements that must be followed for the warranty to remain valid."
  - question: "What is a VPP (Virtual Power Plant) and is it an opportunity for electricians?"
...
|---|---|---|
| Energy density | Lower | Higher (smaller form factor) |
| Cycle life | Very high (3,000–6,000+ cycles) | Moderate (1,500–3,000 cycles) |
| Thermal stability | Very high — safer | Higher thermal runaway risk |
| Installation restrictions | Less restrictive | More restrictive (ventilation, separation) |
| Cost | Lower per kWh | Higher per kWh |
| Common brands | BYD, Sungrow, Growatt | Some LG, Samsung legacy products |
...
> This is Chapter 6 of a free 12-chapter guide covering licensing, EV charging, commercial solar, cash flow, tech stack, marketing, and building a business worth selling.
> [Download The Sparky's Playbook free →](/playbook)

<script type="application/ld+json">
{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What standard governs battery storage installations in Australia?","acceptedAnswer":{"@type":"Answer","text":"AS/NZS 5139:2019 is the primary standard for battery energy storage systems in Australia. It covers design, installation, and commissioning of battery systems, working alongside AS/NZS 3000 and AS/NZS 4777. It introduced requirements around installation location, separation distances, fire protection, and ventilation."}},{"@type":"Question","name":"Do I need CEC battery accreditation to install battery systems?","acceptedAnswer":{"@type":"Answer","text":"Yes. CEC Battery Accreditation is required to install batteries under the STC scheme and access state government rebate programs. If you hold CEC Solar Accreditation, you need to complete an additional training unit to add battery accreditation."}},{"@type":"Question","name":"What are the main AS/NZS 5139 requirements for residential battery installations?","acceptedAnswer":{"@type":"Answer","text":"Key requirements include: minimum separation distances from ignition sources and air intakes, ventilation where batteries can off-gas, fire separation for enclosed spaces, prohibitions on installation in sleeping areas and escape routes, mandatory labelling, and a Battery Installation Certificate on completion."}},{"@type":"Question","name":"What is a VPP and is it an opportunity for electricians?","acceptedAnswer":{"@type":"Answer","text":"A Virtual Power Plant aggregates residential and commercial battery systems dispatched by a central operator for grid services. VPP programs exist in SA, VIC, NSW, and QLD. For electricians, they create installation work and preferred installer arrangements. Register as a preferred installer with major VPP operators in your state."}},{"@type":"Question","name":"What ongoing maintenance do battery systems require?","acceptedAnswer":{"@type":"Answer","text":"Annual inspection of connections for corrosion, software updates, capacity testing, verification that safety systems remain functional, and monitoring review for anomalies. Offering an annual service contract creates a recurring revenue stream and keeps you connected to the customer for system expansions."}}]}
</script>
