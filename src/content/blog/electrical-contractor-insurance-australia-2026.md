...
faq:
  - question: "What insurance is legally required for electrical contractors in Australia?"
    answer: "Public liability insurance is effectively mandatory for licensed electrical contractors in all states — most licensing bodies require evidence of a minimum $5M–$20M public liability policy as a condition of licence issuance or renewal. Workers' compensation insurance is required for any business with employees. Home warranty insurance (domestic building insurance) is required in most states for residential work above certain contract value thresholds ($20,000 in NSW and VIC). Professional indemnity is not legally required but is strongly recommended for businesses that provide design advice or energy consultancy."
  - question: "How much does public liability insurance cost for an electrician in Australia in 2026?"
    answer: "Public liability insurance for a sole trader electrician in Australia typically costs $1,200–$2,500 per year for $10M cover in 2026, depending on your annual turnover, types of work, and claims history. For a 3–5 person electrical business doing solar and battery work, expect $1,500–$3,000/year. Solar-specific public liability policies that cover panel installation, roof work, and electrical connection typically cost 20–30% more than standard electrical-only policies."
  - question: "Do solar installers need different insurance to standard electricians?"
    answer: "Yes — solar installation introduces specific risks that standard electrical contractor policies may not cover, including work at heights, product liability exposure for the system's lifetime, building structure damage during installation, and solar fire liability. Ensure your policy explicitly covers solar PV installation, battery storage, and grid-connected systems. Always disclose your solar and battery revenue split to your broker when sourcing cover."
  - question: "What is professional indemnity insurance and do solar installers need it?"
    answer: "Professional indemnity (PI) insurance covers claims arising from professional advice or design — for example, if a customer suffers financial loss because you provided incorrect advice about system sizing, energy savings, or battery capacity. While not legally required for most electrical contractors, PI is essential for solar businesses that provide energy assessments, ROI projections, or battery sizing recommendations. Typically $1,200–$3,000/year for $1M–$2M cover."
  - question: "What insurance do I need for battery storage installations in Australia?"
    answer: "Battery storage installation requires specific policy wording. Your public liability policy must cover battery installation (some exclude lithium battery work); product liability should extend over the battery system's warranty period; and if a battery system causes property damage due to a fault in your installation, your policy must respond. Ensure your broker confirms in writing that your policy covers AS/NZS 5139 battery installations. Some insurers now require a specific battery storage endorsement."
  - question: "What are the most common insurance gaps that cost solar and electrical businesses money?"
    answer: "The most costly insurance gaps include: professional indemnity excluded from trade packages (leaves design and advice claims uncovered), tools left in unlocked vehicles excluded from claims, battery storage work outside declared scope voiding claims, and domestic building insurance not held for jobs over $20,000. Many businesses also hold only $5M public liability when licensing bodies recommend $10–$20M for commercial work."
---
...
**Why solar installers specifically need PI:**
Solar installation is not just labour — it involves design decisions: system sizing, string configuration, equipment selection, shading analysis, and financial modelling of savings and payback.
...
For a business with 3–5 employees, add workers compensation:
| Workers compensation (3 employees, $150k wages) | $4,500–$9,000 |
| **Total annual insurance with employees** | **$12,200–$24,500** |

This is a significant business cost that needs to be factored into your pricing. See our [hidden costs guide](/blog/hidden-costs-killing-profit-solar-electrician) for a full overhead recovery model.
...
> [Ask Tradie Brain AI free →](https://tradieautomate.com/tools/tradie-brain/) Instant answers on insurance requirements for solar installers, electricians, and trade contractors by state. No login required.
