---
title: "Solar Installer Cash Flow: How to Stop Funding Your Customers' Systems"
description: "Solar installer cash flow survival guide — why the math is stacked against you, the deposit and invoicing fixes that work, and how to stop your business bank account from funding your customers' solar systems."
pubDate: 'Jul 13 2026'
category: "Business Growth"
heroImage: '/hero-hidden-costs-profit.jpg'
tags: ['cash flow', 'solar business', 'invoicing', 'deposits', 'ServiceM8', 'business growth', 'solar installer']
---
...
## Supplier Terms Are a Cash Flow Tool
...
Manage this by:
1. **Building the STC delay into your working capital buffer** — it's predictable, so model it
2. **Using a fast-pay STC aggregator** — some offer next-day or same-week payment for a small fee; the fee may be worth it for cash flow
3. **Invoicing for the full system price** and issuing the STC discount separately, only after the certificates are in your account — this puts the timing risk on the customer rather than you
