// netlify/functions/playbook-lead.js
// Receives POST from tradieautomate.com/playbook form
// Adds contact to Brevo list 5 (The Sparky's Playbook)
...
exports.handler = async (event) => {
  ...
  try {
    ...
    return {
      ...
      body: JSON.stringify({
        success: true,
        downloadUrl: '/sparkys-playbook.pdf',
      }),
    };
  } catch (err) {
    console.error('playbook-lead error:', err);
    return {
      statusCode: 500,
      headers: { ...corsHeaders, 'Content-Type': 'application/json' },
