// netlify/functions/award-rates-lead.js
// Receives POST from tradieautomate.com/award-rates-card form
// Adds contact to Brevo list 4 (Award Rates Card)
...
exports.handler = async (event) => {
  ...
  try {
    ...
    return {
      ...
      body: JSON.stringify({
        success: true,
        downloadUrl: '/electrical-award-rates-card-2026.pdf',
      }),
    };
  } catch (err) {
    console.error('award-rates-lead error:', err);
    return {
      statusCode: 500,
      headers: { ...corsHeaders, 'Content-Type': 'application/json' },
